  ...
  <div class="container flex justify-between items-center px-3">
    <div class="flex justify-between gap-5">
      <a href="#" class=" font-bold">
        <img src="{{asset('assets/images/logo-n1.png')}}" alt="logo" class="w-[150px] sm:w-[250px] ">
      </a>

      <!-- Mobile menu button -->
      <button id="menu-btn" class="lg:hidden block text-[#2E0077] ml-20 focus:outline-none">
        <!-- Hamburger icon -->
    ...
    <nav id="menu" class="hidden lg:flex lg:items-center space-x-8 text-xl"> 
      ...
      <div class="relative inline-block header-nav" id="parcel-wrapper">
        <!-- Button -->
        <button id="parcel-btn" class="flex items-center hover:text-[#2e0077] focus:outline-none">
          Parcel
        ...
        <div id="parcel-dropdown"
            class="absolute mt-6 w-48 bg-[#2e0077] text-white text-sm rounded-md shadow-lg hidden transition-opacity duration-300">
      ...
      <a href="{{ url ('/contact') }}" class="hover:text-[#2e0077] text-black header-nav">Contact Us</a>
