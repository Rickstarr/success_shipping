@extends('layouts.app')
<title>RailParcel | Success Shipping Ventures</title>
@push('styles')

@endpush
@section('content')
<section>
    <div class="relative w-full h-[500px] bg-cover bg-center bg-[url('{{asset('assets/images/train.jpg')}}')] pt-8">
        ...
        <div class="relative z-10 h-full pl-10 mt-[60%] md:mt-[30%] lg:mt-[20%] pt-10">
            <div class="flex">
                ...
                <h1 class="text-white lg:text-5xl text-3xl font-bold">Rail Parcel</h1>
            </div>
...
<section class="mx-auto sm:p-20 p-8">
    <div class="sm:grid-cols-1 grid md:grid-cols-1 lg:grid-cols-[1fr_2fr] gap-9">
        ...
        <div>
            <div><img src="{{asset('assets/images/rail1.jpeg')}}" alt="" srcset="" class="xl:h-[380px] object-cover xl:w-full"></div>
            <div>
                <h1 class="sm:text-4xl md:text-3xl lg:text-4xl uppercase my-7">Rail Parcel</h1>
            ...
            <div class="my-6 space-y-5 text-lg text-[#2f2829]">
                <h1 class="font-semibold text-2xl mt-10">The services offered under Rail Parcel include:</h1>
                <ul>
            ...
            <div class ="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div><img src="{{asset('assets/images/rail2.jpeg')}}" alt="feature" srcset="" class="object-cover"></div>
                <div><img src="{{asset('assets/images/rail3.jpeg')}}" alt="shipping-2" srcset=""></div>
            </div>
        <div>
    </div>
</section>
<section class="mb-5">
    <div class="relative w-full h-[300px] bg-cover bg-center bg-[url('{{asset('assets/images/04.jpg')}}')] pt-8">
        <div class="absolute inset-0 bg-black/40"></div>
